...
function [I] = reconstruct2D_class(list_x_im,list_y_im,x_im,y_im,overlap2,k,n_division,r_z,directory_save)
    ...
    for zone_id = 1:n_zone
        ...
        Ny = length(y);
        [X,Y] = meshgrid(single(x),single(y)); % Make grid points
    ...
    % Save the image
    save(""+directory_save+"./I_2D_division_"+n_division+"_class.mat",'I')
end
