...
function [I] = reconstruct2D_vrm(x_im,y_im,k,n_division,r_z,directory_save)
    ...
    phi_in = load(""+directory_save+"phi_in_"+n_division+"_zone_"+zone_id+"_subvolume_"+subvolume_id+"_vrm.mat").phi_in;
    phi_out = load(""+directory_save+"phi_out_"+n_division+"_zone_"+zone_id+"_subvolume_"+subvolume_id+"_vrm.mat").phi_out;
